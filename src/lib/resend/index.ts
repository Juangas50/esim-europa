  ...
  <div style="max-width:560px;margin:0 auto;padding:32px 16px;">
    ...
    <div style="background:white;border-radius:0 0 16px 16px;padding:32px;border:1px solid rgba(0,0,0,0.06);border-top:none;">
      ...
      <div style="background:#E60000;border-radius:12px;padding:16px;text-align:center;">
        ...
        <a href="https://wa.me/${process.env.WHATSAPP_NUMBER ?? "34647204011"}" style="color:white;font-weight:700;font-size:14px;text-decoration:none;">
...
export async function sendActivationReminder({
  ...
  return resend.emails.send({
    ...
    html: `
      ...
      <p>¿Necesitás ayuda? <a href="https://wa.me/${process.env.WHATSAPP_NUMBER ?? "34647204011"}">Escribinos por WhatsApp</a></p>
      <p>RUTA34 Telecom</p>
    `,
  });
}
