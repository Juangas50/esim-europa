...
const styles = StyleSheet.create({
  ...
  infoValue: { fontSize: 11, fontFamily: 'Helvetica-Bold', color: '#111111' },
  tableHeader: { flexDirection: 'row', backgroundColor: '#111111', paddingVertical: 8, paddingHorizontal: 12 },
